...
//! ```
//!
//! rewrites both golden files from the current renderer and passes. Review
//! the resulting diff: it is the whole point of the pin. There is no CLI
//! flag for this — the binary's CLI surface is frozen for v0.1 by
//! AFM-0001:R1.
